# Phase 0.8 — Strategic Plan (v1, ARCHIVED 2026-06-20)

> ⚠️ **ARCHIVED COPY — DO NOT EDIT.** Authored alongside commit `a9ffc32` (Phase 0.8 Day 1).
> Live working copy is at [../../Phase0.8_Strategic_Plan.md](../../Phase0.8_Strategic_Plan.md)
> (REVISED 2026-06-20 post-KLFIX + post-wash-out).
>
> This v1 file is preserved for historical / audit purposes only. It captures the plan
> as it stood **before**:
>   - the 4-seed KLFIX result (+1.08 pp ± 0.35 pp on canonical n=2916)
>   - the wash-out diagnostic returning Pattern 2 across all 4 PPO variants
>   - the offline ensemble evidence (Cohen-d 3.70 → 7.21)
>   - the promotion of multi-layer reward (T1#6) to Action 1
>
> See the live copy's §0bis status snapshot for the cross-walk between v1 and current.
