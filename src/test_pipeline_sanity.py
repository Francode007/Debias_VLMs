...
CLASS_CHECKS = [
    ...
    ("compute_causal_reward_penalty from rl_components", lambda: getattr(importlib.import_module("modules.rl_components"), "compute_causal_reward_penalty")),
    ("compute_dispersive_loss from rl_components", lambda: getattr(importlib.import_module("modules.rl_components"), "compute_dispersive_loss")),
